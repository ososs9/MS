...
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 MARVEL](t.me/sc_marvel) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/sc_marvel)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/sc_marvel)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'メ🇧🇪( MIDO ELSO8AYER.',url="t.me/Marvel_Mido"}},
{{text = 'MIDO ELKBEER', url="t.me/uu_blackk"}},
{{text = 'ELMODAMER', url="t.me/AL_M_O_D_A_M_ER"}},
{{text = 'CH MARVEL', url="t.me/sc_marvel"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sc_marvel/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
--------------------------------------------------------------------------------------------------------------
if text == "المطور" or text == "مطور" then
local TEXT_SUDO = database:get(bot_id.. Tshake:TEXT_SUDO )
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = SUDO,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name =  [معاك مطور البوت اهو ياروحي ⇈⇊](t.me/sc_marvel)\n[ ..result.first_name_.. ](tg://user?id= ..result.id_.. )\n 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text =   ..result.first_name_..  , url = "https://t.me/"..result.username_..""},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  `𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 MARVEL ★ 𓌺´ ,url="t.me/sc_marvel"}},
{{text =   ᯓ اضف البوت لمجموعتك★   ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/ST_Marvel/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
