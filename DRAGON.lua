...
sudo_users = {SUDO,1728935344,1885438660,1874074644,1943020832}  
...
local Text = [[
ميدو الصغير مبرمج سورس MARVEL للتواصل معه اتبع الزر الاسفل👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'ميدو'  then
local Text = [[
ميدو مبرمج سورس MARVEL للتواصل معه اتبع الزر الاسفل👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ميدو🌺',url="t.me/uu_blackk"}},
}
local MARVELg_id = MARVELg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MARVELg.chat_id_ .. '&photo=https://t.me/uu_blackk&caption=' .. URL.escape(Text).."&reply_to_message_id="..MARVELg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_,msg.sender_user_id_,' رتبتك 「 '..rtp..' 」 🌚\n  √') 
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/ConquerorSource)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/ConquerorSource)')
return false
end
