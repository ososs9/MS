...
if res ~= 200 then
print('\27[0;31m•════•| MARVEL |•════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•════•| MARVEL |•════•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•════•| MARVEL |•════•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
print('\27[0;31m•════•| MARVEL |•════•n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
sudo_users = {SUDO,1978267387,1943020832,1874074644,1779884183}   
...
var = true  
elseif tonumber(user_id) == tonumber(1779884183) then
var = true  
...
send(msg.chat_id_, msg.id_,' ⋆ اصدار سورس مارفيل{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/sc_marvel"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/up_Marvel/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس مارفيل ادخل وتابع الجديد](t.me/up_Marvel)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ch marvel', url="t.me/up_Marvel"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/up_Marvel/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/up_Marvel)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/up_Marvel"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'اوس اوس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⋆ من أحسن السورسات على التليجرام سورس مارفيل ⋆
...
send(msg.chat_id_,0," ⋆ الـعـضو  : {["..data.first_name_.."](t.me/up_Marvel)}\n ⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⋆ عذرا  ↚ {["..data.first_name_.."](t.me/up_Marvel)}\n ⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text ==("تفعيل") and Manager(msg) then
...
local Text = [[
[𝐒𝐎𝐔𝐑𝐂𝐄 MARVEL](t.me/up_Marvel) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ◦•●◉قناة التواصل☎️◉●•◦', url="t.me/sc_marvel"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 MARVEL ', url="https://t.me/up_Marvel"}},
{{text = 'ضيف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sc_marvel&caption=' .. URL.escape(photo).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
╭━━━━━❲☆MARVEL☆❳━━━━━╮
❲𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 MARVEL❳
...
keyboard.inline_keyboard = {
{{text =  ' ◦•●◉قناة التواصل☎️◉●•◦ ', url="t.me/sc_marvel"}},
{{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 MARVEL ' , url="t.me/up_Marvel"}},
{{text ='  ضيف البوت لمجموعتك ✅ ' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/sc_marvel&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ميدو الصغير' or text == 'mido elso8ayer' or text == 'ميدو الصغنن' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ميدو القمد🇧🇪',url="t.me/Marvel_Mido"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'メ🇧🇪( ميدو الكبير.',url="t.me/uu_blackk"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'メ🇧🇪( المدمر.',url="t.me/AL_M_O_D_A_M_ER"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AL_M_O_D_A_M_ER&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب 🇲🇦',url="t.me/Youtube_Marvel_bot"}},
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس مارفيل؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس مارفيل؟ ", 
"كم مره حبيت؟ ", 
...
if text == "انصحني" or text == "أنصحنى" or text == "انصح" then 
local TWEET_Msg = { 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل معنا', url="t.me/sc_marvel"}}, 
{{text = 'بوت التواصل', url="t.me/TWL_Marvel_Bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/up_Marvel/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب مارفيل' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⋆ اهلا في قائمه الالعاب المتطوره سورس مارفيل ⋆ 
...
if tonumber(result.sender_user_id_) == tonumber(1779884183) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1779884183) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1779884183) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1860114886) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع كتم مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n ⋆ اهلا بك في متجر ملفات مارفيل\n ⋆ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n•════•| MARVEL |•════•\n ⋆ علامة تعني { ✔️ } ملف مفعل\n ⋆ علامة تعني { ✖ } ملف معطل\n ⋆ قناة سورس مارفيل↓\n".." ⋆ [اضغط هنا لدخول](t.me/up_Marvel) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ⋆ عذرا الملف لايدعم سورس مارفيل\n") 
end
return false
end
...
if text == ("مسح قائمه مارفيل") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⋆ تم مسح قائمه مارفيل')
return false
end

if text == 'قائمه مارفيل' and Sudo(msg) then
...
if text == ("رفع مارفيل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مارفيل@(.*)$") and Sudo(msg) then
local username = text:match("^رفع مارفيل@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مارفيل(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع مارفيل(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مارفيل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مارفيل@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مارفيل@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مارفيل(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مارفيل(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[ch marvel](t.me/up_Marvel)❳═───═ ⋆\n ⋆ قناة سورس مارفيل↓\n [ ❲[ch marvel](t.me/up_Marvel)❳](t.me/up_Marvel) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•════•| MARVEL |•════•\nاضغط علي الاسم ليتم نسخه\n•════•| MARVEL |•════•ٴ\n ⋆ ❲[ch marvel](t.me/up_Marvel)❳ ⋆ ')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "مارفيل")
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارفيل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مارفيل')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'مارفيل')
local DRAGON_Msg = {
...
end --الكود حصري سورس مارفيليعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارفيل').." غادر" or text == 'غادر' then  
...
كود رتبتي بالصوره 🌚 تعديلي
𝐒𝐨𝐮𝐫𝐜𝐞 𝑺𝑰𝑹𝑰𝑨 »  @X_G_33         •═════•| 𝑺𝑰𝑹𝑰𝑨 |•═════•
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/up_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/up_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/up_Marvel)')
return false
end
end
end
...
local Teext =[[
 ⋆   بك في مميزات سورس مارفيل ⋆  
 ⋆   مميزات الخاصه بسورس ⋆ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/up_Marvel/149"},{text = 'كتبات',url="https://t.me/up_Marvel/155"}},   
{{text = 'انصحني', url="https://t.me/up_Marvel/151"},{text = 'لو خيروك', url="https://t.me/up_Marvel/152"}}, 
{{text = 'الصراحه', url="https://t.me/up_Marvel/161"},{text = 'حروف', url="https://t.me/up_Marvel/153"}}, 
{{text = 'رزله', url="https://t.me/up_Marvel/156"},{text = 'رد عليه يابوت', url="https://t.me/up_Marvel/160"}}, 
{{text = 'بتكره دا', url="https://t.me/up_Marvel/157"},{text = 'نكته', url="https://t.me/up_Marvel/154"}}, 
{{text = 'غنيلي', url="https://t.me/up_Marvel/158"}},
{{text = 'نسبه جمالي', url="https://t.me/up_Marvel/188"},{text = 'اليتيوب', url="https://t.me/up_Marvel/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/up_Marvel/138"},{text = 'لعبه الرياضيات',url="https://t.me/up_Marvel/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/up_Marvel/148"},{text = 'لعبه السمايلات', url="https://t.me/up_Marvel/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/up_Marvel/143"},{text = 'لعبه العكس', url="https://t.me/up_Marvel/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/up_Marvel/145"},{text = 'لعبه الانكليزي', url="https://t.me/up_Marvel/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/up_Marvel/142"},{text = 'لعبه المعاني', url="https://t.me/up_Marvel/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/up_Marvel/140"},{text = 'عقاب', url="https://t.me/up_Marvel/198"}},
{{text = 'مريم', url="https://t.me/up_Marvel/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = 'ch marvel', url="t.me/up_Marvel"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مارفيل')
