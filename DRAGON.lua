...
sudo_users = {SUDO,1728935344,1885438660}  
...
if tonumber(user_id) == tonumber(1728935344
) then  
var = true 
elseif tonumber(user_id) == tonumber(1885438660
) then
var = true  
...
local MARVELg_id = MARVELg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. MARVELg.chat_id_ .. '&photo=t.me/sourse_Marvel/3
=' .. URL.escape(Text).."&reply_to_message_id="..MARVELg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
