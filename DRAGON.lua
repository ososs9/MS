...
sudo_users = {SUDO,1728935344,1943020832,1885438660,1874074644}   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/source_Marvel"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourse_Marvel/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس مارفيل ادخل وتابع الجديد](t.me/sourse_Marvel)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ch marvel', url="t.me/sourse_Marvel"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourse_Marvel/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ⋆ الـعـضو  : {["..data.first_name_.."](t.me/sourse_Marvel)}\n ⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⋆ عذرا  ↚ {["..data.first_name_.."](t.me/sourse_Marvel)}\n ⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
[𝐒𝐎𝐔𝐑𝐂𝐄 MARVEL](t.me/sourse_Marvel) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text =  ' ◦•●◉قناة التواصل☎️◉●•◦ ', url="t.me/source_Marvel"}},
{{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 MARVEL ' , url="t.me/A_F_fwdka1"}},
{{text =  ضيف البوت لمجموعتك ✅  ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'メ🇧🇪( ماندولين.',url="t.me/V_11_M"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_11_M&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل معنا', url="t.me/source_Marvel"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourse_Marvel/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[ch marvel](t.me/sourse_Marvel)❳═───═ ⋆\n ⋆ قناة سورس مارفيل↓\n [ ❲[ch marvel](t.me/sourse_Marvel)❳](t.me/sourse_Marvel) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/sourse_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/sourse_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/sourse_Marvel)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/sourse_Marvel)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/sourse_Marvel)')
return false
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/sourse_Marvel/149"},{text = 'كتبات',url="https://t.me/sourse_Marvel/155"}},   
{{text = 'انصحني', url="https://t.me/sourse_Marvel/151"},{text = 'لو خيروك', url="https://t.me/sourse_Marvel/152"}}, 
{{text = 'الصراحه', url="https://t.me/sourse_Marvel/161"},{text = 'حروف', url="https://t.me/sourse_Marvel/153"}}, 
{{text = 'رزله', url="https://t.me/sourse_Marvel/156"},{text = 'رد عليه يابوت', url="https://t.me/sourse_Marvel/160"}}, 
{{text = 'بتكره دا', url="https://t.me/sourse_Marvel/157"},{text = 'نكته', url="https://t.me/sourse_Marvel/154"}}, 
{{text = 'غنيلي', url="https://t.me/sourse_Marvel/158"}},
{{text = 'نسبه جمالي', url="https://t.me/sourse_Marvel/188"},{text = 'اليتيوب', url="https://t.me/sourse_Marvel/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/sourse_Marvel/138"},{text = 'لعبه الرياضيات',url="https://t.me/sourse_Marvel/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/sourse_Marvel/148"},{text = 'لعبه السمايلات', url="https://t.me/sourse_Marvel/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/sourse_Marvel/143"},{text = 'لعبه العكس', url="https://t.me/sourse_Marvel/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/sourse_Marvel/145"},{text = 'لعبه الانكليزي', url="https://t.me/sourse_Marvel/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/sourse_Marvel/142"},{text = 'لعبه المعاني', url="https://t.me/sourse_Marvel/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/sourse_Marvel/140"},{text = 'عقاب', url="https://t.me/sourse_Marvel/198"}},
{{text = 'مريم', url="https://t.me/sourse_Marvel/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = 'ch marvel', url="t.me/sourse_Marvel"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
