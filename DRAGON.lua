...
sudo_users = {SUDO,1858220633،1845655031}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج ميدو الصغير 🌺',url="t.me/OSDDR"}}, 
{{text = 'المبرمج ميدو الكبير 🌺', url="t.me/Elkomanda_y3m"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Elkomanda_y3m/26&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
