...
local Text = [[ 
[مطورين و مبرمجين السورس](https://t.me/mido_Ofline)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00', url="https://t.me/mido_Ofline"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/DEV_MS/9=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = { 
 ...
 {{text = 'بوت التواصل', url="t.me/Ms_Twasol_bot"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌاصّـلَ  ☑ ➘', url="t.me/Ms_Twasol_bot"}}, 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ♥️',url="t.me/Ms_youtube_bot"}},
