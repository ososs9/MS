...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n\27[0;33;49m')
...
io.write('\27[1;31m 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1858220633,1845655031,1859008079,1589498513}  
...
local UserName = (data.username_ or "ms_midooo")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"  MS♥")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'MS') 
local DRAGON_Msg = { 
...
{{text = '𝒕𝒐 𝒂𝒔𝒌 😍',url="t.me/ms_midooo"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = 'SOURCE MS 🌺',url="t.me/ms_midooo"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس MS ادخل وتابع الجديد](t.me/ms_midooo)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'MS', url="t.me/ms_midooo"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/DEV_MS/9=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
 {{text = ':T::O: :A::S::K:', url="t.me/ms_mido"}},
 {{text = 'بوت التواصل', url="t.me/Enginnermido_bot"}},
 {{text = 'سورس MS', url="t.me/ms_midooo"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/ms_midooo/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = ' ✦تم ارسال الملصق من 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/ms_mido/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00', url="t.me/DEV_MS"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/DEV_MS/9=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بوت التواصل' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌاصّـلَ  ☑ ➘', url="t.me/Enginnermido_bot"}}, 
{{text = 'تواصل MS  ☑ ➘', url="t.me/ms_mido"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/ms_midooo/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✦ اصدار سورس MS{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس✦', url="t.me/ms_mido"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/ms_midooo/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦꧁MS ꧂⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس MS ادخل وتابع الجديد](t.me/ms_midooo)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝐒》MS🌺 ', url="t.me/ms_midooo"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/ms_mido/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦꧁MS ꧂⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس MS ادخل وتابع الجديد](t.me/ms_midooo)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ms_midooo/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/ms_midooo)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
19• •𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍 {تعني قناه السورس https://t.me/ms_midooo}
20• تحديث السورس { لتحديث السورس خاص بوتك 
21• الغاء { للغاء الامر الذي طلبته }
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/ms_midooo"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ✦ من أحسن السورسات على التليجرام سورس MS ✦
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=t.me/ms_mido/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "MS")
...
send(msg.chat_id_,0," ✦ الـعـضو  : {["..data.first_name_.."](T.ME/ms_midooo)}\n ✦ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✦ عذرا  ⇇{["..data.first_name_.."](T.ME/ms_midooo)}\n ✦ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
[[♢ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 MS](t.me/ms_midooo)]

[[♢ | MS 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞](t.me/ms_midooo)]

[[♢ | 𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐁𝐞𝐥𝐨𝐰](t.me/ms_midooo)]
]]
...
{{text = 'ELJOE🌺', url="t.me/Jooyabny"}},
{{text = 'SOURCE MS🌺 ', url="t.me/ms_midooo"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ms_mido/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 𖠪 اهلا بك في سورس MS الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  𖠪 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'MIDO ELSO8AYER🌺',url="t.me/Enginner_mido"}},
{{text = ' MIDO ELKIBER🌺', url="t.me/uu_mido"}},
{{text = ' ELJOE🌺', url="t.me/Jooyabny"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 MS🌺 ', url="t.me/ms_midooo"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/ms_mido/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Text = [[
اوس اوس مبرمج سورس MS للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
ميدو الصغير  مالك سورس MS للتواصل معه اتبع الزر الاسفل👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ميدو الكبير🌺',url="t.me/uu_mido"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جو'  then
local Text = [[
جو مطور سورس MS للتواصل معه اتبع الزر الاسفل👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'جو🌺',url="t.me/Jooyabny"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Jooyabny&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'سورس MS' then
local Text = [[ 
 ✦من أحسن السورسات على التليجرام سورس MS ✦
حمايه.سرعه.دقه وامان
 قناه السورس 👇
  [◐W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 MS☏](http://t.me/ms_midooo)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⁽♔₎𝚂𝙾𝚄𝚁𝙲𝙴 MS|🌺 ', url="t.me/ms_midooo"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂》MS🌺', url="t.me/ms_midooo"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=t.me/ms_mido/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب MS' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ✦ اهلا في قائمه الالعاب المتطوره سورس MS ✦ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/ms_midooo)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mnmnmnmn09/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, " ✦ لا تسطيع حظر المبرمج اوس اوس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ✦ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'ms_midooo')..')'
...
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر المبرمج اوس اوس \n")
return false 
end
...
usertext = '\n ✦ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'ms_midooo')..')'
status  = '\n ✦ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(result.sender_user_id_) == tonumber(1859008079) then  
send(msg.chat_id_, msg.id_, " ✦ لا تسطيع كتم المبرمج اوس اوس")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1845655031) then  
send(msg.chat_id_, msg.id_, " ✦ لا تسطيع كتم مالك السورس")
return false 
end
...
if result.id_ == tonumber(1859008079) then
send(msg.chat_id_, msg.id_, " ✦ لا يمكنك كتم المبرمج اوس اوس \n")
return false 
end
if result.id_ == tonumber(1858220633) then
...
if tonumber(userid) == tonumber(1859008079) then  
send(msg.chat_id_, msg.id_, " ✦ لا تسطيع كتم المبرمج اوس اوس عام")
return false 
end
if tonumber(userid) == tonumber(1845655031) then  
send(msg.chat_id_, msg.id_, " ✦ لا تسطيع كتم مالك السورس")
...
if Get_info then
local TextS = "\n ✦ اهلا بك في متجر ملفات MS\n ✦ ملفات السورس 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n◤━───━MS━───━◥\n\n"
local TextE = "\n𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n ✦ علامة تعني { ✔️ } ملف مفعل\n ✦ علامة تعني { ✖ } ملف معطل\n ✦ قناة سورس MS𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n".." ✦ [اضغط هنا لدخول](t.me/ms_midooo) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✦ عذرا الملف لايدعم سورس MS\n") 
end
return false
end
...
if text == ("مسح قائمه MS") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✦ تم مسح قائمه MS')
return false
end

if text == 'قائمه MS' and Sudo(msg) then
...
if text == ("رفع MS") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع MS@(.*)$") and Sudo(msg) then
local username = text:match("^رفع MS@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع MS(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع MS(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل MS") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل MS@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل MS@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل MS(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل MS(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ✦  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ✦  الرفع  ⇇{ '..setadd..
' }\n'..' ✦  الحظر  ⇇{ '..banm..' }\n\n ✦═───═❲[《𝐒》MS🌺  ](t.me/ms_midooo)❳═───═ ✦\n ✦ قناة سورس MS𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\n [ ❲[《𝐒》MS🌺  ](t.me/ms_midooo)❳](t.me/ms_midooo) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍\nاضغط علي الاسم ليتم نسخه\n𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍ٴ\n ✦ ❲[《𝐒》MS🌺  ](t.me/ms_midooo)❳ ✦ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'MS').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'MS')
local DRAGON_Msg = {
'ننعم يروحي 😻♥️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس MSيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'MS').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مبرمج السورس يروحي😊](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطور السورس يجامد 😍💚](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مالك السورس يجامد 😍💚](t.me/ms_midooo)')
return false
end
if text == 'انا مين' and DevSoFi2(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," ✦انا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..✦♥️](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/ms_midooo)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤✦](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..✦💕](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/ms_midooo)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..✦💕](t.me/ms_midooo)')
return false
end
end
end
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍
 اختر الامر الذي تريدها .↑𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝐒》MS🌺  ](t.me/ms_midooo)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍
 اختر العبه الذي تريدها .↑𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦꧁MS ꧂⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝐒》MS🌺  ](t.me/ms_midooo)❳ 
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'MS')
