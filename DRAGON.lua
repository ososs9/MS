...
{
{text = '𝒄𝒉 marvel', url="t.me/sourse_Marvel"},
},
}
...
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 MARVEL](t.me/sourse_Marvel) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/sourse_Marvel)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/sourse_Marvel)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'メ🇧🇪( MIDO ELSO8AYER.',url="t.me/Marvel_Mido"}},
{{text = 'MIDO ELKBEER🇧🇪', url="t.me/uu_blackk"}},
{{text =  'メ🇧🇪( MANDOLIN. ',url="t.me/V_11_M"}},
{{text = 'CH MARVEL 🇧🇪', url="t.me/sourse_Marvel"}},
}
